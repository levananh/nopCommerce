...
namespace Nop.Web.Controllers
{
    public partial class CustomerController : BasePublicController
    {
        ...
        public virtual IActionResult GdprToolsExport()
        {
            ...
            //export
            var result = _exportManager.ExportCustomerGdprInfoToCsv(_workContext.CurrentCustomer, _storeContext.CurrentStore.Id);
            return File(Encoding.UTF8.GetBytes(result), MimeTypes.TextCsv, "customerdata.csv");
        }
