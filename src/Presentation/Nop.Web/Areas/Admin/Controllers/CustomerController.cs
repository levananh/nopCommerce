    ...
    public partial class CustomerController : BaseAdminController
    {
        ...
        public virtual IActionResult GdprExport(int id)
        {
            ...
            try
            {
                ...
                //export
                var result = _exportManager.ExportCustomerGdprInfoToCsv(customer, 0);
                return File(Encoding.UTF8.GetBytes(result), MimeTypes.TextCsv, $"customerdata-{customer.Id}.csv");
            }
            catch (Exception exc)
            {
